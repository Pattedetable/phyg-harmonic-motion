...
ui_Harmonique = harmonique_main_window.Ui_MainWindow()
ui_Dial = dialog_harmonique.Ui_Dialog()

ui_Dial.setupUi(dialog)
ui_Harmonique.setupUi(window_Harmonique, dialog, None)

# Make main window appear
window_Harmonique.show()
sys.exit(app.exec())
